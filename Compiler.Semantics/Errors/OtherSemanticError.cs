...
public static class OtherSemanticError
{
    ...
    public static Diagnostic BaseTypeMustBeClass(CodeFile file, OrdinaryName className, INameSyntax baseTypeName)
    {
    ...
    public static Diagnostic SupertypeMustBeClassOrTrait(CodeFile file, OrdinaryName typeName, INameSyntax superTypeName)
    {
    ...
    public static Diagnostic CircularDefinitionInSupertype(CodeFile file, INameSyntax supertypeName)
    {
        return new(file, supertypeName.Span, DiagnosticLevel.FatalCompilationError, DiagnosticPhase.Analysis,
