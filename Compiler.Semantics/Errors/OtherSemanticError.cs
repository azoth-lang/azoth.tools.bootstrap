...
public static class OtherSemanticError
{
    ...
    public static Diagnostic BaseTypeMustBeClass(CodeFile file, OrdinaryName className, IOrdinaryNameSyntax baseTypeName)
    {
    ...
    public static Diagnostic SupertypeMustBeClassOrTrait(CodeFile file, OrdinaryName typeName, IOrdinaryNameSyntax superTypeName)
    {
    ...
    public static Diagnostic CircularDefinitionInSupertype(CodeFile file, IOrdinaryNameSyntax supertypeName)
    {
        return new(file, supertypeName.Span, DiagnosticLevel.FatalCompilationError, DiagnosticPhase.Analysis,
