...
public static class TypeError
{
    ...
    public static Diagnostic SupertypeMustBeOutputSafe(CodeFile file, IOrdinaryTypeNameSyntax typeSyntax)
    {
    ...
    public static Diagnostic SupertypeMustMaintainIndependence(CodeFile file, IOrdinaryTypeNameSyntax typeSyntax)
    {
        return new(file, typeSyntax.Span, DiagnosticLevel.FatalCompilationError, DiagnosticPhase.Analysis,
