...
public class TypeSymbolTests : SymbolTestFixture
{
    ...
    public void With_same_name_and_type_are_equal()
    {
        ...
        var sym1 = Type(container, (ObjectType)type.DeclaredType);
        var sym2 = Type(container, (ObjectType)type.DeclaredType);
    ...
    public void With_different_name_are_not_equal()
    {
        ...
        var sym1 = Type(container, (ObjectType)type1.DeclaredType);
        var type2 = DataType("My_Class2");
        var sym2 = Type(container, (ObjectType)type2.DeclaredType);
