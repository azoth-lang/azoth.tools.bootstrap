...
internal static class SymbolBuilder
{
    ...
    public static MethodSymbol Method(TypeSymbol containingSymbol, IdentifierName name, INonVoidType selfParam, IFixedList<ParameterType> @params)
        => new(containingSymbol, MethodKind.Standard, name, selfParam, @params, IType.Void);

    public static MethodSymbol Method(TypeSymbol containingSymbol, IdentifierName name, INonVoidType selfParam, IFixedList<ParameterType> @params, IType @return)
        => new(containingSymbol, MethodKind.Standard, name, selfParam, @params, @return);

    public static MethodSymbol Getter(TypeSymbol containingSymbol, IdentifierName name, INonVoidType selfParam, IType @return)
        => new(containingSymbol, MethodKind.Getter, name, selfParam, FixedList.Empty<ParameterType>(), @return);

    public static MethodSymbol Setter(TypeSymbol containingSymbol, IdentifierName name, INonVoidType selfParam, ParameterType parameter)
