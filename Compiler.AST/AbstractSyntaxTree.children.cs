        ...
        switch (node)
        {
            ...
            case IReturnExpression n:
                if (n.Value is not null)
                    yield return n.Value;
                yield break;
            case IImplicitSimpleTypeConversionExpression n:
                yield return n.Expression;
                yield break;
            ...
            case IImplicitLiftedConversionExpression n:
                yield return n.Expression;
                yield break;
            case IExplicitSimpleTypeConversionExpression n:
                yield return n.Expression;
                yield break;
            ...
            case IMoveExpression n:
                yield return n.Referent;
                yield break;
            case ITempMoveExpression n:
                yield return n.Referent;
                yield break;
            case IFreezeExpression n:
                yield return n.Referent;
                yield break;
            case ITempFreezeExpression n:
                yield return n.Referent;
                yield break;
