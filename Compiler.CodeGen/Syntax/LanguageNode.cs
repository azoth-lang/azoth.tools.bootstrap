...
public sealed class LanguageNode
{
    ...
    //public FixedDictionary<SymbolNode, LanguageNode> RuleDefinedIn { get; }
    ...
    //    => DifferentRules.Contains(rule) && Extends?.Grammar.RuleFor(rule.Defines) is not null;
    ...
    //public FixedDictionary<SymbolNode, LanguageNode> ComputeRulesDefinedIn()
    //{
    //    if (Extends is null)
