...
public sealed class GrammarNode
{
    ...
    //private static IFixedSet<RuleNode> ParentRules(RuleNode rule, IReadOnlyDictionary<SymbolNode, RuleNode> rules)
    ...
    //public RuleNode? RuleFor(SymbolNode nonterminal)
    ...
    //public string TypeName(SymbolNode symbol)
    ...
    //private readonly FixedDictionary<SymbolNode, RuleNode> rulesLookup;
}
