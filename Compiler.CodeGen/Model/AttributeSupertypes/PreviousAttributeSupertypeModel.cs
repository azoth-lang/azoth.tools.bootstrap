...
public sealed class PreviousAttributeSupertypeModel : AttributeSupertypeModel
{
    ...
    public PreviousAttributeSupertypeModel(TreeModel tree, IEnumerable<PreviousAttributeModel> instances)
        : base(tree)
    {
