...
public sealed class PreviousAttributesModel : ContextAttributesModel
{
    ...
    public PreviousAttributesModel(TreeModel tree, IEnumerable<PreviousAttributeModel> instances)
        : base(tree)
    {
